...
setwd("~/Documents/Articulos/ArticuloParkinsonMixture/2SegundoEnvio/ParkinsonMixtureCodes/")
setwd("C:/Users/propietario 1/Dropbox/ArticuloParkinsonClasificacion17/Codes/")
setwd("~/FileDirectory/")
getwd()
